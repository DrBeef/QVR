...
public class AudioCallback {
	...
	public QVRAudioTrack mAudioTrack;
	...
	public void initAudio(int size)
	{
		...
		mAudioTrack = new QVRAudioTrack(AudioManager.STREAM_MUSIC,
				sampleFreq,
...
class QVRAudioTrack extends AudioTrack
{	
	public QVRAudioTrack(int streamType, int sampleRateInHz,
